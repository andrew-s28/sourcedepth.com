  ...
  return (
    <div className="flex flex-col h-full align-middle justify-center m-2 -translate-y-2">
      ...
      >
        ...
        <Link to="/about" className="border-2 bg-dawn-pink-100 dark:bg-night-sky-950 border-night-sky-950 dark:border-dawn-pink-100 rounded-3xl px-5 py-2 w-fit mx-auto group" resetScroll>
    ...
    <IntroCard title="Recent Blog Posts">
      <div className="grid grid-cols-1 gap-4">
        {frontmatters.slice(0, SHOW_N_POSTS).map((fm: IFrontMatter) => (
            <>
          <Link key={fm.slug} to={`/blog/posts/$slug`} params={{ slug: fm.slug }} resetScroll>
            <div className="flex flex-col p-4 rounded-lg group">
              <div className="flex space-x-2 mb-2">
              <h3 className="text-lg font-bold underline decoration-transparent group-hover:decoration-inherit transition-[text-decoration-color] duration-500 m-0">{fm.title}</h3>
...
function SoftwareIntro() {
  return (
    <IntroCard title="Select Software">
      <div className="grid grid-cols-1 gap-4">
          <a href="https://pycoare.readthedocs.io/en/latest/?badge=latest" target="_blank">
            <div className="flex flex-col p-4 rounded-lg group">
              <div className="flex space-x-2 mb-2">
              <h3 className="text-lg font-bold underline decoration-transparent group-hover:decoration-inherit transition-[text-decoration-color] duration-500 m-0">
                PyCOARE
              ...
              <p className="text-sm mb-auto">
                A Python package for calculating various air-sea fluxes from bulk variables (e.g., wind speed, temperature, humidity), using the COARE algorithms developed through the TOGA-COARE project.
              </p>
            </div>
          </a>
            <div className="flex justify-center mx-auto my-1 bg-night-sky-950 dark:bg-dawn-pink-100 h-0.5 w-2/3" />
          <a href="https://github.com/andrew-s28/ooi-profiler-nitrate-retriever" target="_blank">
            <div className="flex flex-col p-4 rounded-lg group">
              <div className="flex space-x-2 mb-2">
              <h3 className="text-lg font-bold underline decoration-transparent group-hover:decoration-inherit transition-[text-decoration-color] duration-500 m-0">
            ...
            <div className="flex justify-center mx-auto my-1 bg-night-sky-950 dark:bg-dawn-pink-100 h-0.5 w-2/3" />
          <a href="https://github.com/andrew-s28/physoce-datasets" target="_blank">
            <div className="flex flex-col p-4 rounded-lg group">
              <div className="flex space-x-2 mb-2">
              <h3 className="text-lg font-bold underline decoration-transparent group-hover:decoration-inherit transition-[text-decoration-color] duration-500 m-0">
                Physoce Datasets
...
function Home() {
  ...
  return (
    <main className="overflow-clip bg-ocean-700">
      ...
      <motion.div
        initial="hidden" animate="visible" variants={parent}
      >
        <BlogsIntro />
        <ProjectsIntro />
        <SoftwareIntro />
